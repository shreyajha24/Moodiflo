  ...
  return (
    <div className="space-y-8 pb-16">
      ...
      {result && <section className="grid grid-cols-1 gap-5 md:grid-cols-2">
        ...
        <article className="panel-quiet rounded-2xl p-5"><p className="eyebrow">{result.targetLanguage} translation</p><p className="mt-3 whitespace-pre-wrap text-sm leading-7 text-cyan-100">{result.translatedText}</p></article>
      </section>}
    </div>
  );
};
